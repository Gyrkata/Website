...
<head>
    ...
    define('ROOT_DIR', 'https://localhost/theatre/');
    ?>
    <meta charset="UTF-8">
    <meta name="viewport"
    ...
    <li><a href="' . ROOT_DIR . 'contact/">Contact</a></li>
     <li><a href="' . ROOT_DIR . 'login"><i class="far fa-user" title="LOGIN/REGISTER"></i></a></li>
        ...
        if ($_SESSION['is_admin'] == 1) {
            echo '<li><a href="' . ROOT_DIR . 'admin/">admin</a></li>';
            echo '<li><a href="' . ROOT_DIR . 'admin/users.php">All users</a></li>';
            echo '<li><a href="' . ROOT_DIR . 'admin/addBlog.php">Add blog</a></li>';
